...
for axx_mult in ['ApprOchs_5']: #['SIAFA1_5', 'SIAFA2_5', 'SIAFA3_5', 'SIAFA4_5', 'SAFAN_5', 'SSAX1_5', 'SSAX2_5', 'SSAX3_5', 'SAID1_5', 'SAID2_5', 'NC_5', 'NCp_5', 'ApprOchs_5']:
    ...
    for epoch in range(15):
        train_one_epoch(model, criterion, optimizer, data_t, "cpu", 0, epoch + 1)
